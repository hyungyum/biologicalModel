...
def train(epochs):
    ...
    for epoch in range(1, epochs):
        ...
        if acc > best_acc:
            ...
            if not os.path.isdir('ckpt_swa'):
                os.mkdir('ckpt_swa')

            path = f'ckpt_swa/model_{model.__class__.__name__}_state_{epoch:03d}_{acc:.4f}.st'
    ...
    # SWA 모델 저장
    torch.save(swa_model.state_dict(), './ckpt_swa/swa_model.pth')
...
if __name__ == '__main__':
    ...
    experiment_name = 'resnet18_swa_epoch50_20interval'  # 직접 입력한 실험명
