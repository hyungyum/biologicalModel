...
def train(epochs):
    ...
    for epoch in range(1, epochs):
        ...
        if acc > best_acc:
            ...
            if not os.path.isdir('ckpt_label_smoothing'):
                os.mkdir('ckpt_label_smoothing')

            path = f'ckpt_label_smoothing/model_{model.__class__.__name__}_state_{epoch:03d}_{acc:.4f}.st'
...
if __name__ == '__main__':
    ...
    experiment_name = 'resnet18_label_smoothing_epoch50'  # 실험명을 설정
